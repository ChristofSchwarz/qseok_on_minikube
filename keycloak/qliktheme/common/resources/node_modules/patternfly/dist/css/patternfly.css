...
.btn-primary {
  background-color: #009844;
  background-image: linear-gradient(to bottom, #009844 0%, #009844 100%);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff009844', endColorstr='#ff009844', GradientType=0);
  border-color: #00659c;
  color: #fff;
}
.btn-primary:hover,
